...
#Fastq files ->  Bowtie2 -> (sam files) ->  HOMER -> (peaks file) ->  IDR -> (bed file) -> TBA -> (coefficients files) -> Processing -> (rank-ordered TF list)
./runAllTBA_upload.sh
...
#Move results back into the testing folders#
